jQuery(document).ready(function($) {
	...
	*************************************/
	...
	$('#search .search-btn').on('click', function(event) {
		...
		$('body').prepend('<div id="search-full" class="fadeIn"> <button id="exit-search-box"><i class="fas fa-times"></i></button> <div class="search-box"> <form action="search" method="GET" class="animated fadeInDown"> <input type="text" name="query" placeholder="Search"> <button type="submit"><i class="fas fa-arrow-right"></i></button> </form> </div></div>').fadeIn('300', function() {
